package com.example.first.a503_19.a1023jsonparsing;
...
public class DetailActivity extends AppCompatActivity {
    ...
    class ThreadEx extends Thread{
        ...
        public void run(){
            ...
            try{
                //다운로드 받을 주소 생성
                URL url = new URL(
                        "http://192.168.0.201:8080/android/getitem?itemid=" + itemid);
                //Connection 만들기
    ...
    class ImgThread extends Thread{
        ...
        public void run() {
            try{
                InputStream is = new URL("http://192.168.0.201:8080/android/img/" + filename).openStream();
